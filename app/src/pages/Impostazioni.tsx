    ...
    <>
      ...
      <Card title="Aspetto" subtitle="Tema, lingua e valuta dell'applicazione.">
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              <label className="block text-xs font-medium text-apple-darkgray mb-1">Lingua</label>
              <select
                value={config.lingua}
                onChange={(e) => aggiorna('lingua', e.target.value as ConfigAspetto['lingua'])}
                className="w-full px-3 py-2 rounded-apple bg-gray-50 border border-gray-200 text-sm text-apple-darkgray focus:outline-none focus:ring-2 focus:ring-apple-blue/40 focus:border-apple-blue transition-all"
              >
            ...
            <div>
              <label className="block text-xs font-medium text-apple-darkgray mb-1">Valuta</label>
              <select
                value={config.valuta}
                onChange={(e) => aggiorna('valuta', e.target.value)}
                className="w-full px-3 py-2 rounded-apple bg-gray-50 border border-gray-200 text-sm text-apple-darkgray focus:outline-none focus:ring-2 focus:ring-apple-blue/40 focus:border-apple-blue transition-all"
              >
      ...
      <Card title="Formati" subtitle="Formato di date e numeri in tutta l'app.">
        <div className="space-y-4">
          <div>
            <label className="block text-xs font-medium text-apple-darkgray mb-1">Formato data</label>
            <select
              value={config.formatoData}
              onChange={(e) => aggiorna('formatoData', e.target.value as ConfigAspetto['formatoData'])}
              className="w-full px-3 py-2 rounded-apple bg-gray-50 border border-gray-200 text-sm text-apple-darkgray focus:outline-none focus:ring-2 focus:ring-apple-blue/40 focus:border-apple-blue transition-all"
            >
              <option value="GG/MM/AAAA">GG/MM/AAAA — 31/12/2026 (Italia)</option>
              <option value="MM/GG/AAAA">MM/GG/AAAA — 12/31/2026 (USA)</option>
              <option value="AAAA-MM-GG">AAAA-MM-GG — 2026-12-31 (ISO)</option>
            </select>
          </div>
          ...
          <div>
            ...
            <select
              value={config.primoGiorno}
              onChange={(e) => aggiorna('primoGiorno', e.target.value as ConfigAspetto['primoGiorno'])}
              className="w-full px-3 py-2 rounded-apple bg-gray-50 border border-gray-200 text-sm text-apple-darkgray focus:outline-none focus:ring-2 focus:ring-apple-blue/40 focus:border-apple-blue transition-all"
            >
          ...
          <div>
            <label className="block text-xs font-medium text-apple-darkgray mb-1">Formato numeri</label>
            <select
              value={config.formatoNumero}
              onChange={(e) => aggiorna('formatoNumero', e.target.value as ConfigAspetto['formatoNumero'])}
              className="w-full px-3 py-2 rounded-apple bg-gray-50 border border-gray-200 text-sm text-apple-darkgray focus:outline-none focus:ring-2 focus:ring-apple-blue/40 focus:border-apple-blue transition-all"
            >
              <option value="italiano">1.234,56 — Italiano</option>
              <option value="internazionale">1,234.56 — Internazionale</option>
            </select>
          </div>
        </div>
      </Card>
